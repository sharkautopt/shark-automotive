        ...
        <section className="py-16 lg:py-24 border-b border-border/50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              <span className="inline-block font-mono text-xs tracking-[0.3em] text-primary uppercase mb-6">
                Contacto
              </span>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div>
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-4 mt-1">
                        <a
                          ...
                          className="font-mono text-xs tracking-wider text-primary hover:text-foreground transition-colors underline underline-offset-4"
                        >
                          Ligar
                        </a>
                        <a
                ...
                {/* Location photo */}
                <div className="mt-8 relative aspect-video border border-border overflow-hidden">
                  <Image
                  ...
                  <div
                    ...
                    style={{ backgroundColor: 'rgba(10, 17, 28, 0.5)' }}
                  >
                    <p className="font-mono text-sm tracking-[0.2em] uppercase text-foreground">
                      Lisboa, Portugal
                    </p>
                  </div>
                </div>
