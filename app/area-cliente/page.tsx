    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="max-w-md border border-border bg-card p-8 text-center">
          <h1 className="font-display text-2xl tracking-wide text-foreground">Sem operação activa</h1>
          ...
          <form action="/login" className="mt-6">
            <a
              href="/login"
              className="inline-block bg-primary px-4 py-3 font-mono text-[11px] uppercase tracking-widest text-primary-foreground"
            >
              Terminar sessão
            </a>
          </form>
