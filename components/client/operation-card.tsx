  ...
  return (
    <div className="space-y-4">
      <div className="border border-border bg-card p-6">
        <h3 className="font-display text-2xl tracking-wide text-foreground">A Tua Operação</h3>
      ...
      <div className="border border-border bg-card p-6">
        <h4 className="font-mono text-[11px] uppercase tracking-widest text-muted-foreground">Resultados</h4>
        {operation.result_amount == null && !operation.result_notes ? (
          ...
          <dl className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="md:col-span-3">
              <dt className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground">Observações</dt>
              <dd className="mt-1 text-sm leading-relaxed text-foreground">{operation.result_notes || '—'}</dd>
            </div>
          </dl>
        )}
      </div>
