...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-card hover:bg-secondary text-foreground border border-border px-4 py-3 transition-colors"
